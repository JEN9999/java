...
@WebServlet("/myDispatcherServlet")  // http://localhost/spring/myDispatcherServlet?year=2022&month=10&day=18
public class MyDispatcherServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			Class clazz = Class.forName("com.practice.spring.YoilTellerMVC");
